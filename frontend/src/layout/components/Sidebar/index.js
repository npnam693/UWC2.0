...
const Sidebar = () => {
    const MenuItem = [
        {   
            content: 'Overview',
            to: '/',
            icon: <WidgetsRoundedIcon sx={{fontSize: '2.5rem', color:'white', marginRight: '10px'}}/>
        },
        {   
            content: 'Task',
            to: '/task',
            icon: <AssignmentRoundedIcon sx={{fontSize: '2.5rem', color:'#8E92BC', marginRight: '10px'}}/>
        },
        {   
            content: 'User',
            to: '/',
            icon: <PortraitRoundedIcon sx={{fontSize: '2.5rem', color:'#8E92BC', marginRight: '10px'}}/>
        },
        {   
            content: 'Message',
            to: '/chat',
            icon: <SmsRoundedIcon sx={{fontSize: '2.5rem', color:'#8E92BC', marginRight: '10px'}}/>
        },
        {   
            content: 'Setting',
            to: '/',
            icon: <SettingsRoundedIcon sx={{fontSize: '2.5rem', color:'#8E92BC', marginRight: '10px'}}/>
        },
        {   
            content: 'Profile',
            to: '/profile',
            icon: <ManageAccountsRoundedIcon sx={{fontSize: '2.5rem', color:'#8E92BC', marginRight: '10px'}}/>
        },
    ]   
                ...
                <div className = {styles.center}>
                    <ul style={{display:'flex', flexDirection:'column'}}>
                        {MenuItem.map((item, index) => (
                            <Button>
                                <Link className={styles.menuItem} key = {index} to = {item.to}>
                                    {item.icon}
